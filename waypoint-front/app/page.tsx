  ...
  return (
    <div className="min-h-screen w-full text-gray-100">
      ...
      <main className="container mx-auto max-w-6xl p-4 md:p-8 flex flex-col items-center">
        <h1 className="text-gray-900 text-4xl md:text-6xl font-bold mt-20 md:mt-32 text-center">
          Aonde você quer ir?
        </h1>
        ...
        >
          ...
          <div className="md:w-1/2 h-68 w-full bg-white/30 rounded-lg flex items-center justify-center">
            <img src="mapa_bg.png" alt="mapa" className="w-full h-full" />
          </div>
        </div>
      </main>
    </div>
